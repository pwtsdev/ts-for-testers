...
// Polimorfizm to zdolność różnych klas do implementowania tej samej metody w różny sposób,
// przy zachowaniu wspólnego interfejsu lub klasy bazowej.

// Inaczej mówiąc: ta sama metoda (describe())
// może działać inaczej w zależności od obiektu, na którym jest wywoływana.
...
const computers: PC[] = [
  new OfficePC('Dell', 'i5', 16, 512, 'Windows 11', true),
  new GamingPC('HP', 'i10', 64, 1024, 'Windows 11', 'RTX 4070', 'Liquid Cooling'),
];

for (const pc of computers) {
  // Wywołanie tej samej metody describe(), ale różne zachowanie – zależnie od typu obiektu
